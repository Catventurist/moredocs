<template>
  <UiCard class="relative items-center justify-center min-h-screen p-4 w-full max-w-xl">
    <UiCardHeader>
      <UiCardTitle class="flex items-center gap-2 justify-between">
      ...
      <form class="w-full" @submit="onSubmit">
        ...
        <section class="flex flex-col px-4 justify-center gap-2">
          <UiFormField v-slot="{ componentField }" name="image">
            <UiFormItem>
              <UiFormControl class="relative items-center group">
                ...
                <Icon name="lucide:image"
                  class="size-6 absolute start-0 inset-y-0 px-2 flex text-muted-foreground duration-300 group-hover:text-foreground" />
              </UiFormControl>
            </UiFormItem>
          </UiFormField>
            ...
            <UiFormItem>
              <UiFormControl class="relative items-center group">
                ...
                <Icon name="lucide:paperclip"
                  class="absolute start-0 inset-y-0 flex items-center justify-center px-2 size-6 text-muted-foreground duration-300 group-hover:text-foreground" />
              </UiFormControl>
            </UiFormItem>
          </UiFormField>
