...
::code-group
  ::div{label="Preview"}
    ...
    :icon{name="vscode-icons:file-type-javascript"}
    :icon{name="vscode-icons:file-type-vue"}
    :icon{name="vscode-icons:file-type-nuxt-icon"}
...
The `value` prop in `::accordion-item`{language="mdc"} is auto-generated by default. You can set them to other _unique_ values and put them in the `default-value` prop of `::accordion`{language="mdc"}.